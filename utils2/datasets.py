...
class LoadRealSense2:  # Stream from Intel RealSense D435
    def __init__(self, width=1280, height=720, fps=30, img_size = 1280):
        # Variabels for setup
        self.width = width
        self.height = height
        self.fps = fps
    ...
    def update(self):
        ...
        while True:
            ...
            color_intrin = aligned_cf.profile.as_video_stream_profile().intrinsics
            ...
            color_image = np.asanyarray(aligned_cf.get_data())
